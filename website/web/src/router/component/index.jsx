...
export default class Components extends Component {
  ...
  render() {
    console.log(`${window.location.protocol}//${window.location.host}/mobile.html#${this.props.location.pathname}`)
    return (
      <Conatiner style={{ background: 'none' }}>
        <div className="component-container">
          ...
          <div className="simulator">
            <iframe src={`${window.location.protocol}//${window.location.host}/mobile.html#${this.props.location.pathname}`} title="simulator" frameBorder="0" />
          </div>
        </div>
